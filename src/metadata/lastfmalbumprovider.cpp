...
void LastFMAlbumProvider::setArtistAlbum(Albumtype album)
{
    mAlbumName = album.album;
    mArtistName = album.artist;
}

void LastFMAlbumProvider::requestDownload(Albumtype album)
{
    mAlbumName = album.album;
    mArtistName = album.artist;
